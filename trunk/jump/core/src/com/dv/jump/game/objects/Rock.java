...
package com.dv.jump.game.objects;
...
public class Rock extends AbstractGameObject {
	...
	public void render(SpriteBatch batch) {
		...
		// Draw right edge
		reg = regEdge;
		batch.draw(reg.getTexture(), position.x + relX, position.y + relY, origin.x
				+ dimension.x / 8, origin.y, dimension.x / 4, dimension.y, scale.x,
